...
extension NSNotification.Name {
    ...
    static let tikiTimeSecondaryDragUpdate     = NSNotification.Name("com.tikitime.secondaryDragUpdate")
    static let tikiTimeSecondaryDragEnd        = NSNotification.Name("com.tikitime.secondaryDragEnd")
}
